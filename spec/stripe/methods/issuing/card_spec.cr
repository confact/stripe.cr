...
describe Stripe::Issuing::Card do
  it "create card" do
    ...
    card = Stripe::Issuing::Card.create(cardholder: "ich_1LfQnkAxmG8F6OKsMEKb6sWF", currency: "usd", type: "virtual")
  ...
  it "retrive card" do
    ...
    card = Stripe::Issuing::Card.retrieve("ic_1LfRCcAxmG8F6OKs45gKnnNe")
    card.id.should eq("ic_1LfRCcAxmG8F6OKs45gKnnNe")
  ...
  it "update card" do
    ...
    card = Stripe::Issuing::Card.update("ic_1LfRCcAxmG8F6OKs45gKnnNe",{metadata: {order_id: "6735"}})
